...
class ProblemDownloader::CodeforcesStrategy
  def problem_params
    params = {
      title: @title,
      raw: @raw_content,
      remote_proxy_vendor: "Codeforces,#{@id}",
  ...
  def download(context)
    ...
    url = "http://codeforces.com/problemset/problem/#{contest_id}/#{problem_id}"
